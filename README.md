...
To view all of the endpoints and their request parameters / bodies, run the backend application and access **http://localhost:8080/swagger-ui/index.html** (local) / **https://<domain_url>/swagger-ui/index.html** (production)

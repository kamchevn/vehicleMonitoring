...
public class VehicleApplicationServiceImpl implements VehicleApplicationService {
    ...
    @Override
    public Page<DisplayVehicleDto> findPage(UserDetails user, String name, String type, Integer pageNum, Integer pageSize) {
    ...
    @Override
    public DisplayVehicleDto createNewVehicle(String name, int year, int totalKilometers, String type, String fuelType, String coolingType, String drivenType, String condition, String insertPeriodType, UserDetails user) {
        Vehicle vehicle = vehicleService.createNewVehicle(name,year,totalKilometers,type,fuelType,coolingType,drivenType,condition,insertPeriodType,user);
        return DisplayVehicleDto.from(vehicle);
    }

    @Override
    public DisplayVehicleDto editVehicle(Long id, String name, int year, int totalKilometers, String type, String fuelType, String coolingType, String drivenType, String condition, String insertPeriodType, UserDetails user) {
        Vehicle vehicle = vehicleService.editVehicle(id,name,year,totalKilometers,type,fuelType,coolingType,drivenType,condition,insertPeriodType,user);
        return DisplayVehicleDto.from(vehicle);
    }

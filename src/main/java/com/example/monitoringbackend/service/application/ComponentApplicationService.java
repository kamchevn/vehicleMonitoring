...
public interface ComponentApplicationService {
  ...
  Page<DisplayComponentDto> findPage(
      Long vehicleId,
  ...
  List<DisplayComponentDto> findAllByVehicleAndTemplateMeasuringUnitType(

...
public class ComponentServiceImpl implements ComponentService {
  ...
  public ComponentServiceImpl(
      ComponentRepository componentRepository, ComponentTemplateService componentTemplateService) {
  ...
  @Override
  public Page<Component> findPage(
      Long vehicleId,
    ...
    return this.componentRepository.findAll(spec, PageRequest.of(pageNum, pageSize));
  }
  ...
  @Override
  public List<Component> findAllByVehicleAndTemplateMeasuringUnitType(

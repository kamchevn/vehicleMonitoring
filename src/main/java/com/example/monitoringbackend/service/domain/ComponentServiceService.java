...
public interface ComponentServiceService {
    ...
    Page<ComponentService> findPage(UserDetails user, Long vehicleId, String checkType, Integer pageNum, Integer pageSize);
    void checkConditionForVehicle(Long id, String checkType, String note, LocalDateTime checkTime, List<ComponentServiceDetail> componentDetails);
}

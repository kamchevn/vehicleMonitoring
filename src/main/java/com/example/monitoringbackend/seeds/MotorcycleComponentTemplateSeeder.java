    ...
    List<ComponentTemplate> templates =
        List.of(
            ...
            new ComponentTemplate(
                ...
                IntervalUnit.BURNT_FUEL,
                1200,
                1000), // water-cooled bikes

            // 🔄 Transmission & Drivetrain
            new ComponentTemplate(
                "Clutch Cable",
                VehicleType.MOTORCYCLE,
                ComponentType.CLUTCH_CABLE,
                IntervalUnit.KILOMETERS,
                15000,
                12000),
            new ComponentTemplate(
            ...
            new ComponentTemplate(
                "Chain Lubrication",
                VehicleType.MOTORCYCLE,
                ComponentType.CHAIN_LUBRICATION,
                IntervalUnit.KILOMETERS,
                2000,
                1000), // chain-driven
            new ComponentTemplate(
                "Drive Belt",
                VehicleType.MOTORCYCLE,
                ComponentType.DRIVE_BELT,
                IntervalUnit.KILOMETERS,
                15000,
                12000), // for belt-driven bikes
            new ComponentTemplate(
                "Drive Oil",
                VehicleType.MOTORCYCLE,
                ComponentType.DRIVE_OIL,
                IntervalUnit.KILOMETERS,
                10000,
                8000),
            new ComponentTemplate(
            ...
            new ComponentTemplate(
                "Rear Shock Absorber",
                VehicleType.MOTORCYCLE,
                ComponentType.REAR_SHOCK_ABSORBER,
                IntervalUnit.KILOMETERS,
                20000,
                15000),
            new ComponentTemplate(
                ...
                VehicleType.MOTORCYCLE,
                ComponentType.STEERING_HEAD_BEARINGS,
                IntervalUnit.KILOMETERS,
                30000,
                20000),
            new ComponentTemplate(
                "Swingarm Bearings",
                VehicleType.MOTORCYCLE,
                ComponentType.SWINGARM_BEARINGS,
                IntervalUnit.KILOMETERS,
                30000,
                20000),

...
public class VehicleController {
  ...
  @Operation(
      summary = "List all vehicles for user",
      description =
          "Checks the user and his role, and finds the vehicles based on his role, and returns them as list.")
  @GetMapping
  ...
  @Operation(
      summary = "List all vehicles for user as Pageable",
      description =
          "Checks the user and his role, finds the vehicles based on his role and returns them as pageable. There can be applied name and type filters for the vehicles searching.")
  @GetMapping("/page")
  public ResponseEntity<Page<DisplayVehicleDto>> getProductPage(
    ...
    Page<DisplayVehicleDto> page =
        this.vehicleService.findPage(
            user, name, type, Integer.parseInt(pageNum) - 1, Integer.parseInt(pageSize));
    return ResponseEntity.ok(page);
  }

  @Operation(
      summary = "Returns vehicle by id",
      description = "Finds the vehicle by it's id and returns the vehicle object matching.")
  @GetMapping("/{id}")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description =
          "Takes all the parameters submitted from the form, checks for errors, and creates a new vehicle in the database.")
  @PostMapping("/create")
  public ResponseEntity<DisplayVehicleDto> createVehicle(
    ...
    return ResponseEntity.ok(
        vehicleService.createNewVehicle(
            ...
            Integer.parseInt(totalKilometers),
            type,
            fuelType,
            coolingType,
            drivenType,
  ...
  @Operation(
      summary = "Insert kilometers/burnt fuel for vehicle",
      description =
          "Finds the vehicle by it's id, and insert kilometers/burnt fuel for that vehicle based on what unitType is selected.")
  @PostMapping("/insertInterval/{vehicleId}")
  public ResponseEntity<String> insertKilometersOrHoursForVehicle(
